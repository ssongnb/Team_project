    		...
    		<div class="table-responsive">
    				<table class="table table-bordered" width="100%" cellspacing="0">
    					...
    					<c:if test="${pageMaker.cri.keyword != null }">
    						<button type="button" id="listbtn" class="btn btn-green float-right" onclick="location.href='listsearch?pageNum=${cri.pageNum}&count=${cri.count}&keyword=${pageMaker.cri.keyword }'">목록</button>
    					</c:if> 
