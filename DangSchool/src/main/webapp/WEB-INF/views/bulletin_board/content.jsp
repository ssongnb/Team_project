    	...
    	<div class="col-sm-6 col-md-10 col-lg-10 ">
    		...
    		<div class="b_body">
    				...
    				<c:if test="${cri.keyword != null }">
    					<button type="button" id="listbtn" class="btn btn-green float-right" onclick="location.href='listsearch?pageNum=${cri.pageNum}&count=${cri.count}&keyword=${cri.keyword }'">목록</button>
    				</c:if>
